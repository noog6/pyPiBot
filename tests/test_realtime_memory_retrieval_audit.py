...
def test_memory_intent_classifier_distinguishes_preference_and_topic_recall() -> None:
    ...
    assert api._classify_memory_intent("Which editor do I usually use?") == "preference_recall"
    assert api._classify_memory_intent("What editor do I normally prefer?") == "preference_recall"
    ...
    assert api._classify_memory_intent("Which editor should I use?") != "preference_recall"
    assert api._classify_memory_intent("What editor do people usually use?") != "preference_recall"
