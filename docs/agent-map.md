...
> [`docs/architecture/decision_arbitration_authority_map.md`](architecture/decision_arbitration_authority_map.md) for implemented arbitration authority seams,
