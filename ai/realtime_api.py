...
class RealtimeAPI:
    ...
    def _configure_event_router(self) -> None:
        ...
        self._event_router.register(
            ...
            self._handle_input_audio_buffer_speech_started_event,
        )
        self._event_router.register(
            "input_audio_buffer.speech_stopped",
            self._handle_input_audio_buffer_speech_stopped_event,
        )
        self._event_router.register(
            "input_audio_buffer.committed",
            self._handle_input_audio_buffer_committed_event,
        )
        self._event_router.register(
            "conversation.item.input_audio_transcription.delta",
            self._handle_input_audio_transcription_partial_event,
        )
        self._event_router.register(
    ...
    async def _handle_input_audio_buffer_speech_started_event(
        self, event: dict[str, Any], websocket: Any
    ) -> None:
        _ = event
        ...
        self._log_utterance_envelope("input_audio_buffer.speech_started")
    ...
    async def _handle_input_audio_buffer_speech_stopped_event(
        self, event: dict[str, Any], websocket: Any
    ) -> None:
        _ = event
        manager = getattr(self, "_micro_ack_manager", None)
        ...
        if self._active_utterance is not None:
            ...
            self._log_utterance_envelope("input_audio_buffer.speech_stopped")
        if self._has_active_confirmation_token():
            self._confirmation_speech_active = False
            self._confirmation_asr_pending = True
    ...
    async def _handle_input_audio_buffer_committed_event(
        self, event: dict[str, Any], websocket: Any
    ) -> None:
        _ = event
        _ = websocket
        self._refresh_utterance_audio_levels()
        self._log_utterance_envelope("input_audio_buffer.committed")
