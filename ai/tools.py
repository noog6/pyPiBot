...
tools.append(
    {
        ...
        "description": (
            ...
            "using the tool result directly, for example 'I'm at 8.08 volts.' and never default "
            "to third-person phrasing like 'Theo's battery is...' unless another explicit mode "
            "requires it. Use inference_reason to choose charger wording: "
            "no_prior_sample='I don't have enough trend data yet to infer whether my charger is "
            "connected.', voltage_rising_pending='I may be seeing the start of charging, but I "
            "can't confirm it yet.', voltage_supported_pending='My voltage looks supported in a "
            "way that could fit a weak charger, but I still can't confirm charging yet.', "
            "voltage_rising with inferred_charger_connected=true='I currently infer that my "
            "charger is connected.', and voltage_falling, voltage_flat, or "
            "voltage_rise_below_threshold with inferred_charger_connected=false='I do not "
            "currently infer that my charger is connected.' If the reading is within 0.5V of the "
            "minimum voltage, complain about it; being near the max is fine."
        ),
        "parameters": {
            "type": "object",
            "properties": {},
